...
int poll_keypad_input(t_Chip8 *chip_8)
{
    ...
    while (kbhit())
    {
        ...
        switch (char_read) {
            ...
            case '4': chip_8->keypad[0x3] = 1; break;

            case 'q': chip_8->keypad[0x4] = 1; break;
            case 'w': chip_8->keypad[0x5] = 1; break;
            case 'e': chip_8->keypad[0x6] = 1; break;
            case 'r': chip_8->keypad[0x7] = 1; break;

            case 'a': chip_8->keypad[0x8] = 1; break;
            case 's': chip_8->keypad[0x9] = 1; break;
            case 'd': chip_8->keypad[0xA] = 1; break;
            case 'f': chip_8->keypad[0xB] = 1; break;

            case 'z': chip_8->keypad[0xC] = 1; break;
            case 'x': chip_8->keypad[0xD] = 1; break;
            case 'c': chip_8->keypad[0xE] = 1; break;
